...
class ActionResult(BaseModel):
	...
	context_change: ContextChange = Field(default=None, description='Optional: The context change from the action.')
...
class ActionContext(BaseModel):
	...
	page: Page
	task: Task
	mouse_cursor: bool = Field(default=False, description='Whether to show the mouse cursor in the screenshot.')
